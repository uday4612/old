...
<head>
	...
	<link href="admin/Default.css" rel="stylesheet">
	</link>
		...
		<div class="well">
			...
			<div class="display" style="margin-top:0px;overflow:auto;">
				...
				<br><tr class="text-error">
                        ...
                        <td style="width:50px;"><?php echo $q; ?> </td>
                        <td style="width:50px;"><?php echo $d; ?> </td>
				...
				<tr class="text-error">
                        ...
                        <td style="width:25px;"><?php echo $row['st5']; ?> </td>
                        <td style="width:25px;"><?php echo $row['st5arri']; ?> </td>
                        <td style="width:50px;"><?php echo $row['Origin']; ?> </td>
                        <td style="width:50px;"><?php echo $row['Destination']; ?> </td>
                        <td style="width:50px;"><?php echo $row['Arrival']; ?> </td>
                        <td style="width:50px;"><?php echo $row['Departure']; ?> </td>
                        <td style="width:20p;"><?php echo $row['Mon']; ?> </td>
                        <td style="width:25px;"><?php echo $row['Tue']; ?> </td>
                        <td style="width:29px;"><?php echo $row['Wed']; ?> </td>
                        <td style="width:25px;"><?php echo $row['Thu']; ?> </td>
